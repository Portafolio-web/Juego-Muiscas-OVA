...
lib.ssMetadata = [
		{name:"chie_atlas_1", frames: [[881,771,92,95],[0,771,879,512],[0,0,1132,769]]}
];
...
(lib.boton = function() {
	this.initialize(ss["chie_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(353.5,-173);

	this.instance_1 = new lib.chie_1();
...
(lib.chieabrir = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.cerrarchie = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.cerrarchie();
	this.instance.setTransform(399.55,-125.1,1,1,0,0,0,46,47.5);
	new cjs.ButtonHelper(this.instance, 0, 1, 1);

	this.instance_1 = new lib.Interpolación3("synched",0);
	this.instance_1.setTransform(3.1,4.4,1,1,0,0,0,3.1,4.4);
...
p.nominalBounds = new cjs.Rectangle(-445.4,-255.9,895.2,512);


(lib.chiecerrar = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(562.45,403.6);

	this.instance_1 = new lib.Interpolación4("synched",0);
	this.instance_1.setTransform(565.5,408,0.0215,0.0242,29.8121,0,0,12.2,10.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},34).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,regX:12.2,regY:10.5,scaleX:0.0215,scaleY:0.0242,rotation:29.8121,x:565.5,y:408},34).wait(1));
...
// stage content:
(lib.chie = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_34 = function() {
		...
		*/
		_this.chieabrir.on('click', function(){
		/*
	...
	// chiecerrar
	this.instance = new lib.chiecerrar();
	...
	// Capa_3
	this.chieabrir = new lib.chieabrir();
	this.chieabrir.name = "chieabrir";
	this.chieabrir.setTransform(965,282.5,1,1,0,0,0,46,47.5);
	this.chieabrir._off = true;
	new cjs.ButtonHelper(this.chieabrir, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.chieabrir).wait(34).to({_off:false},0).to({_off:true},1).wait(35));

	// Capa_2
	this.instance_1 = new lib.Interpolación3("synched",0);
	this.instance_1.setTransform(565.5,408,0.01,0.01,29.8647,0,0,2.5,4.4);

	this.instance_2 = new lib.Interpolación4("synched",0);
	this.instance_2.setTransform(565.5,408);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/chie_atlas_1.png?1630191922122", id:"chie_atlas_1"}
	],
	preloads: []
};
