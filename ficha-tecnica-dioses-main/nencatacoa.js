...
lib.ssMetadata = [
		{name:"nencatacoa_atlas_1", frames: [[882,771,92,95],[0,0,1132,769],[0,771,880,512]]}
];
...
(lib.boton = function() {
	this.initialize(ss["nencatacoa_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.nencaabrir = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.boton();
	this.instance.setTransform(358,-165);

	this.instance_1 = new lib.nencatacoa_1();
	this.instance_1.setTransform(-450,-256);
...
p.nominalBounds = new cjs.Rectangle(-450,-256,900,512);
...
(lib.cerrarnenca = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.nencatacerrar = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_2
	this.cerrarnenca = new lib.cerrarnenca();
	this.cerrarnenca.name = "cerrarnenca";
	this.cerrarnenca.setTransform(978,308.5,1,1,0,0,0,46,47.5);
	new cjs.ButtonHelper(this.cerrarnenca, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.cerrarnenca).to({_off:true},1).wait(34));

	// Capa_2_copia
	this.instance = new lib.Interpolación3("synched",0);
	this.instance.setTransform(582.05,428.05,0.9985,0.9985,0,0,0,9.1,3.8);

	this.instance_1 = new lib.Interpolación4("synched",0);
	this.instance_1.setTransform(582,428,0.01,0.01,30.0487,0,0,-4.4,2.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},34).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,regX:-4.4,regY:2.5,scaleX:0.01,scaleY:0.01,rotation:30.0487,x:582,y:428},34).wait(1));
...
// stage content:
(lib.nencatacoa = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_34 = function() {
		...
		*/
		_this.nencaabrir.on('click', function(){
		/*
	...
	// nencatacerrar
	this.instance = new lib.nencatacerrar();
	...
	// Capa_3
	this.nencaabrir = new lib.nencaabrir();
	this.nencaabrir.name = "nencaabrir";
	this.nencaabrir.setTransform(986,311.5,1,1,0,0,0,46,47.5);
	this.nencaabrir._off = true;
	new cjs.ButtonHelper(this.nencaabrir, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.nencaabrir).wait(34).to({_off:false},0).to({_off:true},1).wait(35));

	// Capa_2
	this.instance_1 = new lib.Interpolación3("synched",0);
	this.instance_1.setTransform(582,428,0.0152,0.01,0,30.0487,29.9663,9,3.6);

	this.instance_2 = new lib.Interpolación4("synched",0);
	this.instance_2.setTransform(582,428);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/nencatacoa_atlas_1.png?1630192355751", id:"nencatacoa_atlas_1"}
	],
	preloads: []
};
