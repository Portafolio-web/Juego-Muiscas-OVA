...
lib.ssMetadata = [
		{name:"sie_atlas_1", frames: [[881,771,92,95],[0,0,1132,769],[0,771,879,511]]}
];
...
(lib.boton = function() {
	this.initialize(ss["sie_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.sieabirir = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.boton();
	this.instance.setTransform(347.5,-173.5);

	this.instance_1 = new lib.sie_1();
	this.instance_1.setTransform(-439.5,-255.5);
...
p.nominalBounds = new cjs.Rectangle(-439.5,-255.5,879,511);
...
(lib.cerrarsia = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.sieabrir = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_2
	this.cerrarrrras = new lib.cerrarsia();
	this.cerrarrrras.name = "cerrarrrras";
	this.cerrarrrras.setTransform(961,285.5,1,1,0,0,0,46,47.5);
	new cjs.ButtonHelper(this.cerrarrrras, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.cerrarrrras).to({_off:true},1).wait(34));

	// Capa_2_copia
	this.instance = new lib.Interpolación3("synched",0);
	this.instance.setTransform(567.5,409.5);

	this.instance_1 = new lib.Interpolación4("synched",0);
	this.instance_1.setTransform(567.5,409.5,0.01,0.01,29.9729,0,0,2.5,4.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},34).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,regX:2.5,regY:4.4,scaleX:0.01,scaleY:0.01,rotation:29.9729},34).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_34 = function() {
		...
		*/
		_this.sieabriri.on('click', function(){
		/*
	...
	// sieabrir
	this.instance = new lib.sieabrir();
	...
	// Capa_3
	this.sieabriri = new lib.sieabirir();
	this.sieabriri.name = "sieabriri";
	this.sieabriri.setTransform(961,283.5,1,1,0,0,0,46,47.5);
	this.sieabriri._off = true;
	new cjs.ButtonHelper(this.sieabriri, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.sieabriri).wait(34).to({_off:false},0).to({_off:true},1).wait(35));
	...
	this.instance_2.setTransform(567.5,409.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/sie_atlas_1.png?1630193176729", id:"sie_atlas_1"}
	],
	preloads: []
};
